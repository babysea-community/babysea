...
We pledge to make participation in BabySea SDK a harassment-free experience for everyone, including creators, artists, designers, and developers, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.

## Scope

This code applies to BabySea SDK issues, pull requests, discussions, security reports, maintainer communication, and shared support spaces. It also applies when someone represents the project in public community settings.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers at `dev@babysea.ai`. All complaints will be reviewed and investigated promptly and fairly.
